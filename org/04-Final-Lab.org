...
[fn:2] The trick is to look at the details in the *Engine* tab, as it
shows what happens with each command you give it. First step moves 7
meters, but the next should move about 9.9 meters (because that is the
square root of 98). Why? Remember the formula a² + b² = c² ? Anyway,
the marbles are clearly to the left of the base station. Perhaps make
a small square and keep getting bigger until it doesn't come back?
